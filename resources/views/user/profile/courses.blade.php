    ...
    @else
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($courses as $course)
                <div class="block bg-gray-100 border-l-4 border-blue-500 p-6 rounded-lg shadow-md hover:bg-gray-200 transition">
                    <div>
                    ...
                    <div class="flex justify-between items-center mt-4">
                        <a href="{{ route('courses.tutors', ['id' => $course->course_id]) }}" class="text-blue-500 hover:underline">View Tutors</a>
